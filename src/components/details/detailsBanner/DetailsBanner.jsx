...
import VideoPopup from "../../vidoePopup/VideoPopup";
...
const DetailsBanner = ({ video, crew }) => {
    ...
    const director = crew?.filter((itr) => itr.job === "Director")
    const writer = crew?.filter((itr) => itr.job === "Screenplay" || itr.job === "Story" || itr.job === "Writer")
